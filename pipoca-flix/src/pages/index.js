  ...
  return (
    <>
      <Head>
        ...
        <script defer src="@/components/characters.js"></script>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.icones}>
          ...
          <div className={styles.selecionar}>
            <button onclick= "mostra('FreddyKrueger','NekoRobin','MichaelMyers','Leatherface','Pennywise','Jason')">Freddy</button>
            <button onclick= "mostra('NekoRobin', 'FreddyKrueger','MichaelMyers','Leatherface','Pennywise','Jason')">Neko</button>
            <button onclick= "mostra('MichaelMyers', 'NekoRobin', 'FreddyKrueger',,'Leatherface','Pennywise','Jason')">Michael Myers</button>
            <button onclick= "mostra('Leatherface', 'NekoRobin', 'FreddyKrueger','MichaelMyers','Pennywise','Jason')">Leatherface</button>
            <button onclick= "mostra('Pennywise','NekoRobin', 'FreddyKrueger','MichaelMyers','Leatherface','Jason')">Pennywise</button>
            <button onclick= "mostra('Jason', 'NekoRobin', 'FreddyKrueger','MichaelMyers','Leatherface','Pennywise',)">Jason</button>
          </div>
